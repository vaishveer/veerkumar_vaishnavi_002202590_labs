...
import model.Product; //model package is being used 
...
public class MainJFrame extends javax.swing.JFrame {
    ...
    //create instance of the class to store
    ...
    public MainJFrame() {
        ...
        product= new Product(); //so that both create and view panel can access the contents
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        SplitPane.setRightComponent(createPanel); //created a createpanel and told the split panel on right it has to createpanel
